...
- **We will pay hackers in XMR or BTC to exploit Kovri responsibly!** Please see our [Vulnerability Response Process](https://github.com/monero-project/kovri/blob/master/doc/VULNERABILITY_RESPONSE_PROCESS.md) for responsible disclosure
