...
LicenseFile=LICENSE
OutputBaseFilename=KovriSetup64
...
[Files]
Source: "bin64\build\kovri.exe";      DestDir: "{app}"; Flags: comparetimestamp
Source: "bin64\build\kovri-util.exe"; DestDir: "{app}"; Flags: comparetimestamp
...
Source: "bin64\pkg\client\*"; DestDir: "{userappdata}\Kovri\client"; Flags: recursesubdirs comparetimestamp
...
Source: "bin64\pkg\config\*"; DestDir: "{userappdata}\Kovri\config"; Flags: recursesubdirs ignoreversion
